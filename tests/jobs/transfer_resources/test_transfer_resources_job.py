...
from services.jobs.transfer_resources.transfer_controller import (
    TransferController,
)


class TestTransferResourcesJob:
    """
    Transfer resources job tests
    """
    ...
    def test_transfer_resources_job(
        self,
        full_config: dict,
        cloud_task_client: CloudTaskPublisher,
        resource_types: list,
        ...
        """
        Tests the Transfer Resources job's ability to transfer
        resources and publish tasks.
        """
