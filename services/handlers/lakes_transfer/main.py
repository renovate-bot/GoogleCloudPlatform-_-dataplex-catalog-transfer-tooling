...
It is designed to restore a search capability within the Dataplex Catalog,
enabling users to find all resources belonging to a specific Lake or Zone.
"""
...
async def process_task(
    task_data: DataplexEntries, response: Response
) -> dict[str, Any]:
    """
